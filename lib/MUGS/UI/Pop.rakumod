...
MUGS::UI::Pop is a Pop/SDL app (`mugs-pop`) and a growing set of UI
plugins to play games in
L<MUGS-Core|https://github.com/Raku-MUGS/MUGS-Core> and
L<MUGS-Games|https://github.com/Raku-MUGS/MUGS-Games> via the
L<Pop UI toolkit|https://gitlab.com/jjatria/pop>.
